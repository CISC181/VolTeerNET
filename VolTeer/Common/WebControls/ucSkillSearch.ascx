    ...
    <asp:Table runat="server">
        <asp:TableRow>
            <asp:TableCell>
                ...
                <asp:RadioButton ID="rbTree" GroupName="MainForm" Checked="false" OnCheckedChanged="rbTreeControl_CheckedChanged" AutoPostBack="true" Text="Auto Complete" runat="server" />
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
