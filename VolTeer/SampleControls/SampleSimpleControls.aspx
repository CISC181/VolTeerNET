    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Panel ID="pnlNew" runat="server">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="RadTextBox2" runat="server" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>--%>
